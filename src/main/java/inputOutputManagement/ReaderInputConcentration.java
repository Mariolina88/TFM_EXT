...
/**
 * The Class ReaderConcentration reads the climatic input files extracting the data of interests.
 * INPUTS:
 ...
 * - date 
 */
public class ReaderInputConcentration {
	...
	//OUTPUT
	public ArrayList <Double> concentration= new ArrayList <Double>();	
	...
	public void process() throws Exception { 
		...
		while ((line = br.readLine()) != null) {
			...
			concentration.add(Double.parseDouble(line.split(csvSplitBy)[1]));
